...
public class Client360Activity extends FragmentActivity {
    ...
    private void editClient(){
        ...
        EditText holder=field("Titular",client.optString("holder","")),name=field("Nombre",client.optString("name","")),surname=field("Apellidos",client.optString("surname","")),identity=field("DNI / NIE",client.optString("identityNumber",client.optString("holderDni",""))),cif=field("CIF",client.optString("cif","")),phone=field("Teléfono",client.optString("phone","")),email=field("Correo electrónico",client.optString("email","")),address=field("Dirección",client.optString("address","")),birth=field("Fecha de nacimiento",client.optString("birthDate","")),type=field("Tipo",client.optString("type","")),number=field("Número de póliza / documento",client.optString("number","")),expiry=field("Vencimiento",client.optString("expiry",client.optString("validityDate",""))),nationality=field("Nacionalidad",client.optString("nationality","")),sex=field("Sexo",client.optString("sex","")),birthPlace=field("Lugar de nacimiento",client.optString("birthPlace",""));
