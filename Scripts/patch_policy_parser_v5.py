...
identity=r'''    private static String extractIdentity(String text,String[] lines){
        ...
        // Fallback: a valid DNI/NIE anywhere in the tomador block only.
...
# Accept OCR variants such as DOC. ID. 44202554G and compact spacing.
...
P.write_text(s,encoding='utf-8');print('policy parser v5 applied')
